...
function generateSpots() {
    ...
    spots.forEach(spot => {
        ...
        img.addEventListener('mouseover', () => {
            img.style.filter = 'brightness(1.2)'; // 明るくする
        });
        ...
        hitbox.style.width = `${(spot.width * 0.7 / 800) * mapWidth}px`; // 表示されている画像の0.7倍の幅
        hitbox.style.height = `${(spot.width * 0.7 / 800) * mapHeight}px`; // 表示されている画像の0.7倍の高さ
