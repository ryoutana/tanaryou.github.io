...
const spots = [
    { name: '会津坂下町', img: '会津坂下町(白地図).png', x: 50, y: 50, width: 50 },
    { name: '会津若松市', img: '会津若松市(白地図).png', x: 150, y: 100, width: 60 },
    ...
    { name: '西会津町', img: '西会津町(白地図).png', x: 214, y: 261, width: 180 },
    { name: '猪苗代町', img: '猪苗代町(白地図).png', x: 350, y: 450, width: 60 },
    { name: '湯川村', img: '湯川村(白地図).png', x: 450, y: 500, width: 50 },
    { name: '磐梯町', img: '磐梯町(白地図).png', x: 50, y: 550, width: 45 },
    { name: '北塩原村', img: '北塩原村(白地図).png', x: 150, y: 600, width: 500 },
